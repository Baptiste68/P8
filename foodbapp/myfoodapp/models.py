...
class saved(models.Model):
    User_id_saved = models.ForeignKey(
        User, on_delete=models.CASCADE, default="1")
    Food_id_foodsub = models.ForeignKey(
        Food, on_delete=models.CASCADE, default="1", related_name='foodsub')
    Food_id_foodissub = models.ForeignKey(
        Food, on_delete=models.CASCADE, default="1", related_name='foodissub')
